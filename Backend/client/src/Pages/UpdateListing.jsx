 ...
 useEffect( ()=>{
  ...
  const handleChange = (e) => {
    ...
    if (
      ...
      setFormData({
        ...
        //the value of e.target.checked can be true or false so we're using the
      });
    }
    if (
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      //the '+' sign in the beginning converts the formData.regularPrice & formData.discountPrice number
        ...
        <div className="flex flex-col flex-1 gap-4">
          ...
          <div className="flex gap-4 pt-3">
            ...
            <button
              ...
              className="p-3 text-green-700 border rounded-lg border-green-700 uppercase hover:shadow-lg disabled:opacity-80"
            >
